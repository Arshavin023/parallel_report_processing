...
with DAG("updated_expanded_hts_prep", start_date=datetime.datetime(2024, 4, 26), schedule_interval=None,
    ...
    expanded_prep = PostgresOperator(
        task_id="expanded_prep",
        postgres_conn_id="lamisplus_conn",
        sql = 'call expanded_hts_prep.proc_expanded_prep()',
        autocommit = True
    )

    expanded_hts = PostgresOperator(
        task_id="expanded_hts",
        postgres_conn_id="lamisplus_conn",
    ...
    start >> update_period_table >> [prep_current_pc,prep_baseline_pc,prep_baseline_bp,prep_baseline_urinalysis, 
              ...
              prep_current_alt] >> expanded_hts_joined >> expanded_hts >> expanded_prep >> end