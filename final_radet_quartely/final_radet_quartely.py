...
with DAG("final_radet_quartely", start_date=datetime.datetime(2024, 7, 1), schedule_interval=None,
    ...
    start >> update_period_table >> upd_hiv_status_tracker >> [cte_bio_data, cte_biometric, cte_case_manager, cte_ovc, cte_sample_collection_date,
             cte_tblam, sub_cte_current_vl_result, cte_carecardcd4, cte_labcd4, cte_tb_sample_collection,sub_cte_triage_current_clinical,
             ...
             ] >> cte_current_vl_result >> cte_naive_vl_data >> cte_current_clinical >> cte_tbstatus >> cte_ipt >> radet_joined >> final_radet_quartely >> end