...
with DAG("expanded_radet_weekly_datamart_server",start_date=datetime.datetime(2024, 7, 1),schedule_interval=None,
    ...
    with TaskGroup(group_id='upstream_tasks') as upstream_tasks:
        ...
        cte_current_status = PostgresOperator(
            ...
            postgres_conn_id="radet_conn",
            sql='call expanded_radet.proc_currrent_status()',
            autocommit=True
        )
