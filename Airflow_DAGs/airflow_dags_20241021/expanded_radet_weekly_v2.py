...
with DAG("lamisplus_radet_generation_dwh_server_v2",start_date=datetime.datetime(2024, 7, 1),schedule_interval=None,
    ...
    start >> update_period_table >> upstream_tasks >> midstream_tasks >> downstream_tasks >> radet_joined >> expanded_radet_weekly >> end
