...
(
    ...
    ods_datim_id character varying COLLATE pg_catalog."default",
...
-- Index: odsdatimidloadtime_ods_count_monitoring_backup

-- DROP INDEX IF EXISTS public.odsdatimidloadtime_ods_count_monitoring_backup;

CREATE INDEX IF NOT EXISTS odsdatimidloadtime_ods_count_monitoring
    ON public.ods_count_monitoring USING btree
    (ods_datim_id COLLATE pg_catalog."default" ASC NULLS LAST, period_end_date ASC NULLS LAST)
;
