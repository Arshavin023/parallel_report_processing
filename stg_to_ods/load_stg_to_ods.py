...
import stg_to_ods as lamisplus_funcs
...
with DAG("load_stg_to_ods", start_date=datetime.datetime(2024, 1, 26), schedule_interval=None,
 default_args=default_args, catchup=False, max_active_runs=1) as dag:
    ...
    start >> [patient_person,case_manager,case_manager_patients,patient_visit,
             ...
             hiv_art_pharmacy_regimens,hiv_eac_session,biometric,hiv_eac,dsd_devolvement, 
             ...
             pmtct_infant_mother_art,pmtct_infant_rapid_antibody] >> end
