...
with DAG("load_stg_to_ods", start_date=datetime(2024, 1, 26), schedule_interval=timedelta(hours=2),
 default_args=default_args, catchup=False, max_active_runs=1) as dag:
    ...
    start >> [patient_person,case_manager,case_manager_patients,patient_visit,
             ...
             pmtct_infant_mother_art,pmtct_infant_rapid_antibody] >> end >> trigger_refresh_streaming_dag
