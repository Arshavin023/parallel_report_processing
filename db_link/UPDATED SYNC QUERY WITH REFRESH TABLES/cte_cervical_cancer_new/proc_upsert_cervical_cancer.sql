...
INSERT INTO expanded_radet.cervical_cancer
select * from dblink('db_link_ods',
...
ON CONFLICT (uuid,cerv_ods_datim_id)
DO UPDATE SET dateOfCervicalCancerScreening=EXCLUDED.dateOfCervicalCancerScreening,
			  ...
			  hiv_observation_archived=EXCLUDED.hiv_observation_archived;
