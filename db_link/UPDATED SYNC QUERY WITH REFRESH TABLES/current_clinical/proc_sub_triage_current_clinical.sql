...
SELECT * 
FROM expanded_radet.cte_sub_sub_triage_current_clinical
WHERE max_rownum=1;

drop table if exists expanded_radet.cte_sub_sub_triage_current_clinical;
alter table expanded_radet.cte_sub_sub_triage_current_clinical_new rename to cte_sub_date_current_clinical;
...
ON expanded_radet.cte_sub_sub_triage_current_clinical (MAXDATE, person_uuid, ods_datim_id);
