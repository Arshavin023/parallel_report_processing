...
with DAG("expanded_radet_weekly",start_date=datetime.datetime(2024, 7, 1),schedule_interval=None,
    ...
    start >> update_period_table >> upstream_tasks >> midstream_tasks >> radet_joined >> expanded_radet_weekly >> end
