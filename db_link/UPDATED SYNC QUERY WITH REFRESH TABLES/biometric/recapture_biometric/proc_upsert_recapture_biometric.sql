-- PROCEDURE: expanded_radet.proc_upsert_recapture_biometric()

-- DROP PROCEDURE IF EXISTS expanded_radet.proc_upsert_recapture_biometric();
...
INSERT INTO expanded_radet.recapture_biometric
select * from dblink('db_link_ods',
...
END 
$BODY$;
ALTER PROCEDURE expanded_radet.proc_upsert_recapture_biometric()
