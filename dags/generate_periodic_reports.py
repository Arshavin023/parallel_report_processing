...
with DAG("generate_periodic_reports", start_date=datetime(2025, 5, 18),
         ...
         params={"periods": None},
         max_active_runs=1,
         tags=["AWS", "LamisPlus", "Reports", "HTS, MaternalCohort, HTS_Index, TB, EAC, AHD, Biometric", "Periodic"]
         ) as dag:
    ...
    start >> update_radet_period >> update_prep_period >> generate_first_report_batch >> generate_second_report_batch >> generate_fourth_report_batch >> end
