...
import sys
import os
from lamisplus_funcs import stg_to_ods_desc as lamisplus_funcs
...
with DAG("lamis_stg_to_ods_desc", start_date=datetime(2024, 1, 26), schedule_interval=timedelta(hours=1),
