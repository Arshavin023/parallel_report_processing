...
def trigger_dag_function(**kwargs):
    trigger_dag(dag_id='ACE5_V3_client_radet_generation')
...
# Define the DAG
with DAG("ACE5_V2_client_radet_generation",
    ...
    trigger_ace5_v3_dag = PythonOperator(
        task_id='trigger_ace5_v3_dag',
        python_callable=trigger_dag_function,
        provide_context=True,
    )

    # Define task dependencies
    start >> update_period_table >> task_group_endpoints >> end >> trigger_ace5_v3_dag
