...
def trigger_dag_function(**kwargs):
    trigger_dag(dag_id='ACE6_V2_client_radet_generation')
...
# Define the DAG
with DAG("ACE6_V1_client_radet_generation",
    ...
    trigger_ace6_v2_dag = PythonOperator(
        task_id='trigger_ace6_v2_dag',
        python_callable=trigger_dag_function,
        provide_context=True,
    )

    # Define task dependencies
    start >> update_period_table >> task_group_endpoints >> end >> trigger_ace6_v2_dag
