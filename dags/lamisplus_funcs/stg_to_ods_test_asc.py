...
credential_path = '/home/lamisplus/database_credentials/config.ini'
# r'C:\Users\5300\Documents\Palladium\database_credentials\config.ini'
csv_file_path = '/home/lamisplus/airflow/dags/files/datatypes.csv'
# r'C:\Users\5300\Documents\Palladium\lamisplus_sync_ods_pipeline\dags\files\datatypes.csv'
...
def process_stg_to_ods(table_name, constraints, dtype=None):
    ...
    cur.execute("""SELECT file_name 
                ...
                AND processed = 'N' 
                AND load_time > '2025-05-26' 
                ORDER BY load_time ASC
                LIMIT 1""", (staging_table,))
    ...
    if file_names:
        try:
            ...
            ORDER BY stg_load_time ASC""", con=staging_conn, params=(file_names,))
            ...
            if not df.empty:
                try:
                    print(f'Transforming data on {staging_table}...')
