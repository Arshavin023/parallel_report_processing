...
with DAG("generate_periodic_reports_v2", start_date=datetime(2025, 5, 18),
         schedule_interval=None,
         default_args=default_args,catchup=False,
         params={"periods": None},
         max_active_runs=1,
         tags=["AWS", "LamisPlus", "Reports", "RADET, HTS, PrEP, MaternalCohort, HTS_Index, TB, EAC, AHD, Biometric", "Periodic"]
         ) as dag:
    ...
    with TaskGroup(group_id='generate_first_report_batch') as generate_first_report_batch:
        ...
        pmtcthts_task = PythonOperator(
            task_id="pmtcthts",
            python_callable=run_pmtcthts_report,
            provide_context=True,
        )
    ...
    generate_first_report_batch >> generate_second_report_batch >> \
    generate_third_report_batch >> generate_fourth_report_batch >> end
